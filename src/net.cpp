...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Agricoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"agricoin.asia", "45.32.106.246"},
    {"pool.agricoin.asia", "45.32.105.78"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"test.agricoin.asia", "45.32.106.246"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Agricoin is probably already running."), addrBind.ToString().c_str());
        else
